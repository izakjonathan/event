...
export default function ArtistBookingForm() {
 ...
 <p className="mt-3 eos-body eos-muted">Send artist details, links, image, availability, technical needs and preferred fee.</p>
 {message && <p className="mt-4 rounded-2xl border eos-border eos-panel p-3 eos-body">{message}</p>}
 </Card>
 ...
 <label className="block cursor-pointer rounded-[22px] border border-dashed eos-border eos-panel p-4 text-center eos-body eos-muted">
 ...
 <Card className="space-y-3">
 <h3 className="eos-title">Links</h3>
 {LINK_FIELDS.map((key) => (
 ...
 <Card className="space-y-3">
 <h3 className="eos-title">Availability and needs</h3>
