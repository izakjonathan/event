...
export default function UIStudio() {
 ...
 <p className="mt-4 max-w-[28ch] text-base eos-muted">
 ...
 >
 <span className="eos-body block ">Night</span>
 <span className="mt-1 block eos-caption opacity-70">Dark canvas, light text and muted borders.</span>
 </button>
 <button
 type="button"
 onClick={() => setMode('day')}
 ...
 >
 <span className="eos-body block ">Day</span>
 <span className="mt-1 block eos-caption opacity-70">Light canvas, dark text and muted borders.</span>
 </button>
 </div>
 </Card>
 ...
 <div className="flex items-end justify-between gap-3">
 <div>
 <p className="eos-caption eos-muted">Editable tokens</p>
 ...
 className="eos-danger mt-3 rounded-full border px-3 py-1.5 eos-caption"
 >
 Delete preset
 </button>
 )}
